...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time_created', models.DateTimeField(verbose_name='Created at')),
                ('time_modified', models.DateTimeField(verbose_name='Modified at')),
                ...
                ('qb_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='Id from QuickBooks')),
                ('tracking_number', models.CharField(blank=True, max_length=16, null=True, verbose_name='Tracking number')),
                ('total_amount', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Total amount')),
                ('sync', models.BooleanField(default=True, verbose_name='Synchronization flag')),
                ('company', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='users.UserCompany', verbose_name='Company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='Name')),
                ('desc', models.CharField(blank=True, max_length=100, verbose_name='Desc')),
                ('qb_link', models.PositiveIntegerField(blank=True, null=True, verbose_name='Id from QuickBooks')),
                ('po', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='purchase_orders.PurchaseOrder', verbose_name='PurchaseOrder')),
            ],
            options={
